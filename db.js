// db.js — CommonJS module for json-server
// Loads all Star Wars data collections from data/*.json
// Usage: const getDb = require('./db.js'); const db = getDb();

const path = require('path');

const load = (file) =>
  require(path.join(__dirname, 'data', file));
